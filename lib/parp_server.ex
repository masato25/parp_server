defmodule ParpServer do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: ParpServer.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    ParpServer.Endpoint.config_change(changed, removed)
    :ok
  end
end
